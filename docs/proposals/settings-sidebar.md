...
> ⚠️ **這張圖有時效性。** 它顯示的是 macOS 版的 TokenBar 品牌，今天正確——macOS 尚未改名。**macOS 在 v2.0 改名為 Syrtis 之後，這張圖就會變成「Syrtis 專案裡放著舊品牌的截圖」**，屆時需要重拍或明確標註。macOS 端的品牌稽核只掃 macOS repo，掃不到這裡，所以這條註記就是唯一的提醒。
