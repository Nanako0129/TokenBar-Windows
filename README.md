...
ARM64 gates plus fresh review on 2026-07-19; GitHub PR #3 tracks its current
remote CI and review state. `cargo fmt` is not currently a repository CI gate;
